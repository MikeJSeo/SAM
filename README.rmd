...
To use the shiny version of SAM, first install required packages. Cut and paste what's below in an R session.
...
That will bring up a browser window with a user interface. More details are provided in the [manual](https://github.com/MikeJSeo/SAM/blob/master/sam.pdf)
