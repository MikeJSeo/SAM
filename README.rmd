...
That will bring up a browser window with a user interface. More details are provided in the sam-manual.pdf in this directory. Example data are in Data examples folder and sample output is in the Sample Output folder.
